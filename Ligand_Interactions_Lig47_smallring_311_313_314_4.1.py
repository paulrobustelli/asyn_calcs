...
trajdir='/dartfs-hpc/rc/home/k/f0044gk/labhome/DESRES_Trajectories/DESRES-Trajectory_biorxiv2021-6626290_ligand47_asyn_cterm/biorxiv2021-6626290-no-water-glue/'
pdb='/dartfs-hpc/rc/home/k/f0044gk/labhome/DESRES_Trajectories/DESRES-Trajectory_biorxiv2021-6626290_ligand47_asyn_cterm/biorxiv2021-6626290-no-water-glue/asyn_cterm_lig47.pdb'
dcd='asyn_cterm_lig47.dcd'
trj = md.load("%s/%s"%(trajdir,dcd),stride=1, top=pdb)
...
#Ligand Charged atom is N-329
#Attached Amine Hydrogens are 331 and 330
#Sulfoynl Oxygens are O-302 and O-303
#Sulfonyl S is S-301
#Ring 1 is C-307,308,309,311,313,314
...
np.savetxt('charge_contacts.BF.bf.dat',np.column_stack((residue_number, charge_contact_fraction/desres_bf)),fmt='%.4f')
...
plt.xlim(residue_offset, residue_offset+residues-1)
plt.tight_layout()
plt.savefig('ChargeContactFraction.bf.png')
plt.clf()
...
ligand_hphob=top.select("residue 1 and not element H")
...
ligand_hphob=top.select("residue 1 and element C")
...
np.savetxt('hphob_contacts.bf.%s.dat'%desres_bf, hphob_by_res, fmt='%.4f')
...
plt.xlim(residue_offset, residue_offset+residues-1)
plt.tight_layout()
plt.savefig("HydrophobicContactFraction.LigandCarbon.ProteinCarbon_andnotCA.bf.png")
#plt.show()
plt.clf()
print(hphob_by_res)
...
#ligand_rings=[[311,309,308,307,314,313]]
#ligand_rings=[[311,309,308,307,314,313,300,301,304]]
...
for i in range (0,n_rings):
 ...
 print(ligand_rings[i][3],ligand_rings[i][4],ligand_rings[i][5])
 ligand_centers_normals=get_ring_center_normal_trj_assign_atomid(positions,3,4,5) 
...
np.savetxt('aromatic_stacking.fraction.bf.dat', hphob_by_res, fmt='%.4f')
...
plt.xlim(residue_offset, residue_offset+residues-1)
plt.tight_layout()
plt.savefig('AromaticStackingFraction.bf.png')
plt.clf()
...
hbond_by_res_bf=np.column_stack((residue_number, HB_Total_ave/desres_bf))
np.savetxt('HbondFraction.all.bf.dat',hbond_by_res_bf,fmt='%.4f')
...
plt.xlim(residue_offset, residue_offset+residues)
plt.tight_layout()
plt.savefig('HbondFraction.allframes.bf.png')
#plt.show()
plt.clf()
...
plt.legend(loc='upper left')
plt.tight_layout()
plt.savefig('LigandInteractions.bf.png')
plt.clf()
#plt.show()
